...
list_strings = ['разработка', 'сокет', 'декоратор']

print(f'Список слов: {list_strings}')
for each in list_strings:
    print(f'Элемент списка:{each}, тип: {type(each)}')
print()
...
list_unicode = [unicode1, unicode2, unicode3]

print(f'Список юникодных точек: {list_unicode}')
for each in list_unicode:
    print(f'Элемент списка: {each}, тип: {type(each)}')